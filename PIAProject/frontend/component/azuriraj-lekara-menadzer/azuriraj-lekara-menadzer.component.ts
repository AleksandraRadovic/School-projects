...
@Component({
  selector: 'app-azuriraj-lekara-menadzer',
  templateUrl: './azuriraj-lekara-menadzer.component.html',
  styleUrls: ['./azuriraj-lekara-menadzer.component.css']
})
export class AzurirajLekaraMenadzerComponent implements OnInit {
...
this.staro_kor_ime=this.lekar.kor_ime;
  ...
  azuriraj(){
    ...
    //}
    //else{
      this.router.navigate(['menadzer_lekar'])
    //}
  }
}
