...
@Component({
  selector: 'app-azuriraj-profil-pacijent',
  templateUrl: './azuriraj-profil-pacijent.component.html',
  styleUrls: ['./azuriraj-profil-pacijent.component.css']
})
export class AzurirajProfilPacijentComponent implements OnInit {
...
this.staro_kor_ime=this.pacijent.kor_ime;
  ...
  azuriraj(){
    ...
    //}
    //else{
      this.router.navigate(['profil_pacijent'])
    //}
  }
}
